...
export const Submit = () => {
    ...
    // reset использовать лучше в useEffect, при проверке isSubmitSuccessful
    useEffect(() => {
    ...
    return (
        <div className={styles.container}>
            ...
            <Left>
                <p>В данном блоке:</p>
                <ul>
                    <li>Смотрим, на какие переменные можно ориентироваться при корректной отправки формы, чтоб как то с ней взаимодействовать</li>
                    <li>Как очистить форму, после ее успешной отправки и просто</li>
                    <li></li>
                </ul>
            </Left>
            <Right>
