        ...
        <div className={styles.container}>
            <Left>
                ...
                <ul>
                    ...
                    <li>Посмотреть через кнопку все поля для валидации или только какое то одно поле</li>
                </ul>
            </Left>
            <Right>
                <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <button type='button' onClick={() => trigger()}>Посмотреть поля для валидации</button>
