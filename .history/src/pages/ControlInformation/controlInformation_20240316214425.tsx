...
export const Control = () => {
    ...
    // метод isDirty следит за всей формой !!!! Коррекно раюотает только в том случае, 
    // если есть дефолтные значения у полей, в противном случае он всегда тру !!!!
    ...
    return (
        <div className={styles.container}>
            <Left>
                <p>В данном блоке:</p>
                <ul>
                    <li>Реализована возможность следить за вводимыми данными в поля ввода</li>
                    <li>Получать данные из формы</li>
                    <li>Изменять данные из формы</li>
                    <li>Проверять валидность формы целиком</li>
                    <li>Проверять были ли внесены изменения в инпуты во всей форме</li>
                    <li>Проверять наличие ошибок во всех полях формы сразу</li>
                </ul>
            </Left>
            <Right>
                ...
                <form className={styles.form} onSubmit={handleSubmit(onSubmit, onErrors)}>
                    ...
                    {/* с помощью isValid и isDirty мы можем проверять форму и устанавливать для кнопки disabled */}
                    <button disabled={!isDirty || !isValid} type='submit'>Отправить</button>
