...
export const Control = () => {
    ...
    // в примере ниже поля (touch, dirty),  тригерятся в форме
    const setTriggerLastName = () => {
        setValue("lastName", "Антропов", {
            shouldDirty: true,
            shouldTouch: true,
            shouldValidate: true
        })
            ...
            <div className={styles.container}>
                ...
                <Right>
                    ...
                    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <button type="button" onClick={setUserName}>Изменить имя</button>
                        <button type="button" onClick={setTriggerLastName}>Получить имя</button>
                    </form>
