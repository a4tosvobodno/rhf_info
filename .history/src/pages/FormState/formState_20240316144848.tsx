                            ...
                            {fields.map((field, index) => {
                                return (
                                    <div key={field.id}>
                                        ...
                                        {index > 0 && (<button type='submit' onClick={() => append({ number: '' })}>Отправить</button>)}
                                    </div>
                                )
                            })}
                            <button type='button'>Добавить номер телефона</button>
                        </div>
                    </div>
                    <button type='submit' onClick={() => append({ number: '' })}>Отправить</button>
                </form>
