    ...
    return (
        <div className={styles.container}>
            <Left>
                <p>В данном блоке:</p>
                <ul>
                    <li>Работа с валидацией разными способами, подробнее в коде, в коментах</li>
                    <li>Работа с ошибками и нюансы их отрисовки в приложении</li>
                </ul>
            </Left>
            <Right>
                <form className={styles.form} onSubmit={handleSubmit(onSubmit)} noValidate>
                    ...
                    <input id="name" {...register('name', {
                        ...
                        // можно валидировать так
                        validate: {
                            isAdmin: (fieldValue) => {
                                return fieldValue !== "admin" || "Используйте другое имя"
                            },
                            isOleg: (fieldValue) => {
                                return fieldValue !== "Олег" || "Используйте другое имя"
                            }
                        }
                    })} type='text' />
